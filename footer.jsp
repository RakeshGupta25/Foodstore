...
<html lang="en">
 ...
 <footer class="footery" style="background:rgb(25, 25, 102) ; margin-top: 50px;" >
 
  <div class="row   pt-2 pb-5">
    <div class="col-lg-4 col-md-6 col-sm-12 pt-5">
      
      <img src="img/log.png" alt="image not found" width="250px" height="100px">
      <h1 style="margin-left: 10px; color:crimson; text-align: left; font-style: italic;" >FoodStore</h1>
